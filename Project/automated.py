...
if __name__ == "__main__":
	...
	# get policy for the generated food
	policy, grid, grid3d, grid_reward, reward_position, discount = value_iteration_v1.value_iteration_init(row, col)
	for i in range(0, 100):
		policy = value_iteration_v1.value_iteration(policy, grid, grid3d, grid_reward, reward_position, discount)
